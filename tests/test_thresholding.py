...
class ModelGroupThresholderTest(TestCase):
    ...
    def setup_data(self, engine):
        ...
        distance_rows = [
            ...
            (1, 1, '2014-01-01', 'false positives@', '100_abs', 40, 10, 10),
            ...
            (1, 2, '2015-01-01', 'false positives@', '100_abs', 40, 10, 10),
            (1, 3, '2016-01-01', 'precision@', '100_abs', 0.46, 0.0, 0.11),
            (1, 3, '2016-01-01', 'recall@', '100_abs', 0.46, 0.0, 0.11),
            (1, 3, '2016-01-01', 'false positives@', '100_abs', 40, 10, 10),
            ...
            (2, 4, '2014-01-01', 'false positives@', '100_abs', 40, 10, 10),
            ...
            (2, 5, '2015-01-01', 'false positives@', '100_abs', 40, 10, 10),
            (2, 6, '2016-01-01', 'precision@', '100_abs', 0.34, 0.12, 0.11),
            (2, 6, '2016-01-01', 'recall@', '100_abs', 0.46, 0.0, 0.11),
            (2, 6, '2016-01-01', 'false positives@', '100_abs', 40, 10, 10),
            ...
            (4, 10, '2014-01-01', 'false positives@', '100_abs', 40, 10, 10),
            ...
            (4, 11, '2015-01-01', 'false positives@', '100_abs', 40, 10, 10),
            (4, 12, '2016-01-01', 'precision@', '100_abs', 0.25, 0.21, 0.21),
            (4, 12, '2016-01-01', 'recall@', '100_abs', 0.46, 0.0, 0.11),
            (4, 12, '2016-01-01', 'false positives@', '100_abs', 40, 10, 10),
            ...
            (5, 13, '2014-01-01', 'false positives@', '100_abs', 40, 10, 10),
            ...
            (5, 14, '2015-01-01', 'false positives@', '100_abs', 40, 10, 10),
            (5, 15, '2016-01-01', 'precision@', '100_abs', 0.46, 0.0, 0.11),
            (5, 15, '2016-01-01', 'recall@', '100_abs', 0.3, 0.16, 0.11),
            (5, 15, '2016-01-01', 'false positives@', '100_abs', 40, 10, 10),
            # 2014: model group 6 is failed by false positives
            (6, 16, '2014-01-01', 'precision@', '100_abs', 0.5, 0.0, 0.38),
            (6, 16, '2014-01-01', 'recall@', '100_abs', 0.5, 0.0, 0.38),
            (6, 16, '2014-01-01', 'false positives@', '100_abs', 60, 30, 10),
            # 2015: model group 6 is failed by false positives
            (6, 17, '2015-01-01', 'precision@', '100_abs', 0.5, 0.38, 0.0),
            (6, 17, '2015-01-01', 'recall@', '100_abs', 0.5, 0.0, 0.38),
            (6, 17, '2015-01-01', 'false positives@', '100_abs', 60, 30, 10),
            (6, 18, '2016-01-01', 'precision@', '100_abs', 0.46, 0.0, 0.11),
            (6, 18, '2016-01-01', 'recall@', '100_abs', 0.5, 0.0, 0.38),
            (6, 18, '2016-01-01', 'false positives@', '100_abs', 40, 10, 10),
        ]
