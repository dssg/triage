#+TITLE: A deeper look into triage
#+DESCRIPTION:
...
#+OPTIONS: tasks:todo
#+OPTIONS: LaTeX:t
#+EXPORT_FILE_NAME: ../docs/triage_intro.md
...
model. You can use the tables generated by the grid (see section  [[file:ml_governance.org][Machine Learning Governance]] )
