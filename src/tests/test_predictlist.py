...
def test_predict_forward_with_existed_model_should_write_predictions(
    finished_experiment,
):
...
def test_predict_forward_with_existed_model_should_be_same_shape_as_cohort(
    finished_experiment,
):
    model_id = 1
    as_of_date = "2014-01-01"
...
def test_predict_forward_with_existed_model_matrix_record_is_populated(
    finished_experiment,
):
    model_id = 1
    as_of_date = "2014-01-01"
...
@pytest.mark.skip(
    reason="Config comparison fails: stored config has runtime-generated cohort_table_name fields"
)
def test_experiment_config_from_model_id(finished_experiment):
    model_id = 1
    experiment_config = experiment_config_from_model_id(
        finished_experiment.db_engine, model_id
    )
