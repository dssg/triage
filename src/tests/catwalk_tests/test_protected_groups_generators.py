...
def create_demographics_table(db_engine, data):
    with db_engine.begin() as conn:
        conn.execute(text("""drop table if exists demographics;
...
def test_protected_groups_generator_replace(db_engine):
    ...
    table_generator.generate_all_dates(
        as_of_dates, cohort_table_name="cohort_abcdef", cohort_hash="abcdef"
    )
...
def test_as_dataframe(db_engine):
    ...
    protected_df = table_generator.as_dataframe(as_of_dates, cohort_hash="abcdef")
