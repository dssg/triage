...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['experiment_hash'], ['results.experiments.experiment_hash'], ),
    sa.ForeignKeyConstraint(['model_group_id'], ['results.model_groups.model_group_id'], ),
    sa.PrimaryKeyConstraint('model_id'),
    schema='results'
    )
    op.create_index(op.f('ix_results_models_model_hash'), 'models', ['model_hash'], unique=True, schema='results')
    ...
    sa.PrimaryKeyConstraint('model_id', 'evaluation_start_time', 'evaluation_end_time', 'example_frequency', 'metric', 'parameter'),
    schema='results'
    )
