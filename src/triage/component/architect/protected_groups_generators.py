...
class ProtectedGroupsGenerator(object):
    ...
    def generate_all_dates(self, protected_groups_table_name, as_of_dates, attribute_columns, cohort_table_name, source_table_name, knowledge_date_column):
    ...
    def generate(self, start_date, protected_groups_table_name, attribute_columns, cohort_table_name, source_table_name, knowledge_date_column):
